...
// same as num_bins in spectral_mul_accum
#define NUM_BINS 255
...
main(void)
{
    ...
    while (num_bins > 0)
    {
        ...
        // I want you to check if it segfaults on the last iteration
