                          ...
                          q7_t                *out_0)
{
    ...
    while (remaining > 0)
    {
        ...
        /* left_shift[i]  = max(shift[i], 0);  right_shift[i] = max(-shift[i], 0) */
        vint32m4_t vleft_s  = __riscv_vmax_vx_i32m4(vshift, 0, vl);
        vint32m4_t vright_s = __riscv_vmax_vx_i32m4(__riscv_vneg_v_i32m4(vshift, vl), 0, vl);
        ...
        vint32m4_t vresult_0 = __riscv_vsmul_vv_i32m4(vacc_0, vmult, __RISCV_VXRM_RNU, vl);
        vint32m4_t vresult_1 = __riscv_vsmul_vv_i32m4(vacc_1, vmult, __RISCV_VXRM_RNU, vl);
        vint32m4_t vresult_2 = __riscv_vsmul_vv_i32m4(vacc_2, vmult, __RISCV_VXRM_RNU, vl);
        vint32m4_t vresult_3 = __riscv_vsmul_vv_i32m4(vacc_3, vmult, __RISCV_VXRM_RNU, vl);
        vint32m4_t vresult_4 = __riscv_vsmul_vv_i32m4(vacc_4, vmult, __RISCV_VXRM_RNU, vl);
        vint32m4_t vresult_5 = __riscv_vsmul_vv_i32m4(vacc_5, vmult, __RISCV_VXRM_RNU, vl);
        vint32m4_t vresult_6 = __riscv_vsmul_vv_i32m4(vacc_6, vmult, __RISCV_VXRM_RNU, vl);

        /* divide_by_power_of_two: round(result >> right_shift) */
        vresult_0 = __riscv_vssra_vv_i32m4(vresult_0, vright_u, __RISCV_VXRM_RNU, vl);
        vresult_1 = __riscv_vssra_vv_i32m4(vresult_1, vright_u, __RISCV_VXRM_RNU, vl);
        vresult_2 = __riscv_vssra_vv_i32m4(vresult_2, vright_u, __RISCV_VXRM_RNU, vl);
        vresult_3 = __riscv_vssra_vv_i32m4(vresult_3, vright_u, __RISCV_VXRM_RNU, vl);
        vresult_4 = __riscv_vssra_vv_i32m4(vresult_4, vright_u, __RISCV_VXRM_RNU, vl);
        vresult_5 = __riscv_vssra_vv_i32m4(vresult_5, vright_u, __RISCV_VXRM_RNU, vl);
        vresult_6 = __riscv_vssra_vv_i32m4(vresult_6, vright_u, __RISCV_VXRM_RNU, vl);
    ...
    return out_6; /* points one past the last written byte of the 7th output row */
}
