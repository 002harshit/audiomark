...
#include "ee_api.h"
  ...
  (__riscv_v_intrinsic >= 1000000) && !defined(DISABLE_RISCV_V_EXT)
#define IS_RISCV_V_EXT_SUPPORTED 1
...
///////////////////////////////////////
// RISCV AUDIOMARK V-EXT IMPLEMENTATION
ee_status_t vext_riscv_cfft_init_f32(ee_cfft_f32_t *p_instance, int fft_length);

void vext_riscv_cfft_f32(
  ee_cfft_f32_t *p_instance,
  ee_f32_t *p_buf,
  uint8_t ifftFlag,
  uint8_t bitReverseFlagR
);

ee_status_t vext_riscv_rfft_init_f32(ee_rfft_f32_t *p_instance, int fft_length);

void vext_riscv_rfft_f32(
  ee_rfft_f32_t *p_instance, ee_f32_t *p_in, ee_f32_t *p_out, uint8_t ifftFlag
);

void vext_riscv_absmax_f32(
  const ee_f32_t *p_in, uint32_t len, ee_f32_t *p_max, uint32_t *p_index
);

void vext_riscv_cmplx_mult_cmplx_f32(
  const ee_f32_t *p_a, const ee_f32_t *p_b, ee_f32_t *p_c, uint32_t len
);

void vext_riscv_cmplx_conj_f32(
  const ee_f32_t *p_a, ee_f32_t *p_c, uint32_t len
);

void vext_riscv_cmplx_dot_prod_f32(
  const ee_f32_t *p_a,
  const ee_f32_t *p_b,
  uint32_t len,
  ee_f32_t *p_r,
...
void vext_riscv_f32_to_int16(
  const ee_f32_t *p_src, int16_t *p_dst, uint32_t len
);

void vext_riscv_add_f32(
  ee_f32_t *p_a, ee_f32_t *p_b, ee_f32_t *p_c, uint32_t len
);

void vext_riscv_subtract_f32(
  ee_f32_t *p_a, ee_f32_t *p_b, ee_f32_t *p_c, uint32_t len
);

void vext_riscv_dot_prod_f32(
  ee_f32_t *p_a, ee_f32_t *p_b, uint32_t len, ee_f32_t *p_result
);
...
void vext_riscv_cmplx_mag_f32(ee_f32_t *p_a, ee_f32_t *p_c, uint32_t len);

void vext_riscv_offset_f32(
  ee_f32_t *p_a, ee_f32_t offset, ee_f32_t *p_c, uint32_t len
);

void vext_riscv_vlog_f32(ee_f32_t *p_a, ee_f32_t *p_c, uint32_t len);

void vext_riscv_mat_vec_mult_f32(
  ee_matrix_f32_t *p_a, ee_f32_t *p_b, ee_f32_t *p_c
);

void vext_riscv_nn_init(void);
